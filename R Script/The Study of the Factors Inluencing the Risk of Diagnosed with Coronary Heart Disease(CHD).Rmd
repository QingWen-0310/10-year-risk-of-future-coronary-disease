...
Table 1 shows an overview of the data structure. The variable TenYearCHD indicates whether the patient has a 10-year-risk of developing a CHD, so we will use this as the binary response in the logistic model. Among all the potential predictors, variables male, age, currentSmoker, BPMeds, diabetes, totChol, BMI are selected as predictors in this study. 
